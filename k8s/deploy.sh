...
# kubectl -n kubernetes-dashboard port-forward svc/kubernetes-dashboard-kong-proxy --address 127.10.1.3 8443:443
# naviagte to https://dashboard.clugest.home:8443
